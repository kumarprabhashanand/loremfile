...
The narrative `CHANGELOG.md` used to carry: how each part was built, what broke, what was
measured, and what a verification actually established. It was moved here on 2026-09-17
because the changelog is published at `/changelog` and had grown to roughly 14,000 words
of material written for whoever maintains this, not for whoever downloads a file.

**Nothing here was rewritten.** Every entry is verbatim, in its original order, with its
original heading. What belongs in `CHANGELOG.md` instead is what a user of the files can
see: fixtures added or removed, changes to the URL contract, and changes to the site.
