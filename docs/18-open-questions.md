...
| Q-05 | Off-account cold backup to AWS S3 (Glacier Deep Archive ≈ USD 0.001/GB-month; ≈ USD 0.01/month) in addition to GitHub Releases? | No (GitHub Releases suffice); yes if the AWS account is kept for something else | Resilience vs another account to keep alive |
