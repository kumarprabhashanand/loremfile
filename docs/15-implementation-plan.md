...
| M0.5 | Email Routing (`hello@`, `security@`) and notifications | ✅ **Done** — confirmed 2026-09-15: the routes exist. Their destinations are not recorded anywhere in this repository |
