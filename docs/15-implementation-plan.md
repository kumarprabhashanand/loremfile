...
| M3.7 | `archive.py` (zip/tar/gz/bz2/xz/zst/7z), `font.py`, `mail.py`, `calendar.py`, `cert.py`, `wasm.py`, `web.py` (html/css/js/webmanifest/srt/vtt/har/ipynb) | 6 h |
