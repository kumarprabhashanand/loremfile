    ...
    try:
        ...
        if legal_env:
            ...
            audit = legal_module.audit(
                target,
                values,
                in_git=lambda value: legal_module.in_repository(value, cwd=root),
                forbidden=legal_module.forbidden_from(os.environ),
                forbidden_in_git=lambda text: legal_module.in_repository(
                    text, cwd=root, ignore_case=True
                ),
            )
