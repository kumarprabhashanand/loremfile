...
### Changed — the site (2026-09-21)

- The Impressum and Privacy links are in the footer of every page, one click away, and no longer repeated in the header.
- The favicon, the home-screen icon, the social card and the mark are no longer served with `X-Robots-Tag: noindex`, so search engines and social platforms can show them. Every fixture and data file keeps its headers unchanged.
